Public Class clsIniFile
    ...
    Public Sub WriteBoolean(ByVal Section As String,
      ByVal Key As String, ByVal Value As Boolean)
        ...
        WriteString(Section, Key, CInt(Int(Value)))
        Flush()
    End Sub
    ...
    Public Sub ProfileDeleteItem(sSection As String,
                              sKeyName As String)
        ...
        'vbNullString as the sValue parameter. 

        Call WritePrivateProfileString(sSection,
                                       sKeyName,
                                       vbNullString,
                                       strFilename)
        Flush()
