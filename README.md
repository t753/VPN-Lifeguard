...
downloaded source code and run it (the gambas3 dependencies must be installed to do this (sudo apt-get install gambas3 ... after adding the repository for it ... see Linux page of this repsoitory).
